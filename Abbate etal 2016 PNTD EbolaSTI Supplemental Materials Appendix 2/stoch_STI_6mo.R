###################################################################
#   Monte Carlo simulations *WITH* Convalescent Transmission (6mo)#
#                                                                 #
#  Accompanying:                                                  #
#                                                                 #
...
test <- "6 month conv period"  #e.g., "lowest R0"
...
alpha <- 1/178.6         # 6 months = (365/12)*6-1/gamma days
...
#write.table(outs,"Stoch_STI_6mo_summaries_1000.csv")
...
#######################################
# pdf("stoch_1000_cumul_STI_6mo.pdf", width = 6, height = 4)
...
# Weekly Incidence
#######################################
# pdf("stoch_200_peak_STI_6mo.pdf", width = 5, height = 4)
...
# tail incidence
####################################
# pdf("stoch_200_tail_STI_6mo.pdf", width = 6, height = 4)
...
arun<-84            # an example run 9 and 29 works too
